...
export default function Pricing() {
	return (
		<section className="container-narrow py-14">
			<h1 className="text-3xl md:text-4xl font-semibold text-[color:var(--brand-text)]">Pricing</h1>
			...
			<div className="grid md:grid-cols-3 gap-6 mt-10">
				<div className="rounded-xl border border-black/10 bg-[color:var(--brand-surface)] p-6">
					<h2 className="text-xl font-semibold text-[color:var(--brand-text)]">Starter</h2>
				...
				<div className="rounded-xl border border-black/10 bg-[color:var(--brand-surface)] p-6 ring-2 ring-[color:var(--brand-accent)]/30">
					<h2 className="text-xl font-semibold text-[color:var(--brand-text)]">Pro</h2>
				...
				<div className="rounded-xl border border-black/10 bg-[color:var(--brand-surface)] p-6">
					<h2 className="text-xl font-semibold text-[color:var(--brand-text)]">Enterprise</h2>
